      ...
      appBar: AppBar(
        ...
        actions: [
          if (state.items.any((n) => !n.read))
            TextButton(onPressed: ctrl.markAllRead, child: const Text('Mark all')),
        ],
      ),
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return _NotificationCell(
                        ...
                        onTap: () {
                          ctrl.markRead(n.id);
                          if (n.deepLink != null && n.deepLink!.startsWith('/')) {
            ...
            child: Column(
              ...
              children: [
                ...
                Text(item.body, maxLines: 2, overflow: TextOverflow.ellipsis,
                    style: theme.textTheme.bodySmall?.copyWith(color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.65))),
                const SizedBox(height: 4),
                Text(
                  DateFormat.yMMMd().add_jm().format(item.createdAt),
                  style: theme.textTheme.labelSmall?.copyWith(color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.45)),
                ),
              ],
            ),
          ),
